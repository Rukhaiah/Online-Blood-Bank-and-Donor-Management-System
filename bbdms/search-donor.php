...
$sql = "SELECT * FROM tblblooddonars WHERE status = :status AND BloodGroup = :bloodgroup AND State = :state OR District = :district";
$query = $dbh -> prepare($sql);
...
echo htmlentities($result->State);
}
?></p>
...
{
  echo '<div style="text-align: center; color:red; font-size:25px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;No Record Found</div>';
